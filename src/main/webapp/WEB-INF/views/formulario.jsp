...
<body>
	...
	<h1 class=" p-3 mb-2 bg-dark text-white">Formulário Qintess</h1>
	<div class="login-page p-3 mb-2 bg-dark text-white">
		<form : form method="post" action="${salva}" modelAttribute="dado">

			<div>
				<label>Por Favor, insira seu nome completo :</label> <input
					type="text" name="nomeColaborador">

			</div>

			<br>Atualmente, você atua em uma área técnica?<input
				type="radio" value="Sim" name="radio" id="toggle-1">
			<label for="toggle-1"> Sim </label> <input type="radio"
				name="radio" value="Nao" id="toggle-2"> Não
			...
			<br> <label for="validationTextarea">Possui restrição do
				local de atuação? <select name="restricaoLocalAtuacao">
					...
					<label for="validationTextarea">Formação Acadêmica: <select
						name="formacaoAcademica">
						...
						</script> <label class="col-md-14">Idade de cada filho (caso possua):</label>
							<form class="col-md-14" name="idadeDosFilhos" method="post">

								
								<div class="col-md-18">
								 <textarea name="idadeFilhos" value="" placeholder="separe por virgula para cada filho" id="hidden1"></textarea>  <br> <br>
								<label class="custom-control-label"
									for="customControlValidation2">Possui certificados?</label> <input
									type="radio" name="certificacoes" value="Sim" id="toggle-1"> <label
									for="toggle-1">Sim</label> <input type="radio"
									name="certificacoes" value="Nao" id="toggle-1"> <label
									...
									<div class="form-group">
										...
										<label>Off-Topic (Fale sobre você, sobre seus hobbies)</label>
										<textarea class = "col-md-8"  name="offTopic"></textarea>
										</div>
							...
							<div class="form-group">
								...
								<div class="col-md-14">
									<button id="salva" name="salva" class="btn btn-success">Enviar</button>
								</div>
							</div>
</body>
</html>
